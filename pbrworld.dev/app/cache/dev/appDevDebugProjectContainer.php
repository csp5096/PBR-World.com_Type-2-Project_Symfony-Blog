...
class appDevDebugProjectContainer extends Container
{
     ...
     * This method always returns the same instance of the service.
     *
     * @return \BlogBundle\Twig\Extensions\BloggerBlogExtension A BlogBundle\Twig\Extensions\BloggerBlogExtension instance.
     */
    protected function getBloggerBlog_Twig_ExtensionService()
    {
        return $this->services['blogger_blog.twig.extension'] = new \BlogBundle\Twig\Extensions\BloggerBlogExtension();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony', 'user' => 'root', 'password' => 'Hkmp7@2014', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $c, $g, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_6c24a00b469a57063fac5f7ff9548a05cd8f128e2c736c507582acd161f3294c');
    ...
    {
        return $this->services['swiftmailer.plugin.redirecting'] = new \Swift_Plugins_RedirectingPlugin(array(0 => 'development@PBRWorld.dev'), array());
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('10cc9eacb323906650a3a88b114bd5b10ab2ddc7');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56bd55dd7782e5.02134596')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_user' => 'root',
            'database_password' => 'Hkmp7@2014',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '10cc9eacb323906650a3a88b114bd5b10ab2ddc7',
            'blogger_blog.emails.contact_email' => 'contact@email.com',
            'blogger_blog.comments.latest_comment_limit' => 10,
            'locale' => 'en',
            'bloger_blog.emails.contact_email' => 'assistant@email.com',
            ...
            'kernel.secret' => '10cc9eacb323906650a3a88b114bd5b10ab2ddc7',
            ...
            'swiftmailer.mailer.default.single_address' => 'development@PBRWorld.dev',
            'swiftmailer.mailer.default.delivery_addresses' => array(
                0 => 'development@PBRWorld.dev',
            ),
            ...
            'swiftmailer.single_address' => 'development@PBRWorld.dev',
